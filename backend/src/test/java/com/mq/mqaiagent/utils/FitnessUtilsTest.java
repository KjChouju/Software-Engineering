...
public class FitnessUtilsTest {
    ...
    @Test
    public void testEstimateCaloriesBurned_allExerciseTypes_andDefault() {
        Float w = 60.0f;
        Integer d = 60;
        assertEquals(210.0f, FitnessUtils.estimateCaloriesBurned(w, d, FitnessConstant.ExerciseType.WALKING), 0.01f);
        assertEquals(480.0f, FitnessUtils.estimateCaloriesBurned(w, d, FitnessConstant.ExerciseType.RUNNING), 0.01f);
        assertEquals(360.0f, FitnessUtils.estimateCaloriesBurned(w, d, FitnessConstant.ExerciseType.CYCLING), 0.01f);
        assertEquals(420.0f, FitnessUtils.estimateCaloriesBurned(w, d, FitnessConstant.ExerciseType.SWIMMING), 0.01f);
        assertEquals(300.0f, FitnessUtils.estimateCaloriesBurned(w, d, FitnessConstant.ExerciseType.STRENGTH_TRAINING), 0.01f);
        assertEquals(150.0f, FitnessUtils.estimateCaloriesBurned(w, d, FitnessConstant.ExerciseType.YOGA), 0.01f);
        assertEquals(180.0f, FitnessUtils.estimateCaloriesBurned(w, d, FitnessConstant.ExerciseType.PILATES), 0.01f);
        assertEquals(270.0f, FitnessUtils.estimateCaloriesBurned(w, d, FitnessConstant.ExerciseType.DANCING), 0.01f);
        assertEquals(360.0f, FitnessUtils.estimateCaloriesBurned(w, d, FitnessConstant.ExerciseType.MARTIAL_ARTS), 0.01f);
        assertEquals(240.0f, FitnessUtils.estimateCaloriesBurned(w, d, "未知运动"), 0.01f);
    }
